...
const CENTER_INFO_TEXT_SEARCH_TIP = 'Use "[tag_name]" in your search query to make search more accurate'
const CENTER_INFO_TEXT_NOTHING_FOUND = 'Nothing was found'

const ANSWERS_INFO_TEXT_NO_ANSWERS = 'No answers'
...
module.exports = {
  ...
  CENTER_INFO_TEXT_SEARCH_TIP: CENTER_INFO_TEXT_SEARCH_TIP,
  CENTER_INFO_TEXT_NOTHING_FOUND: CENTER_INFO_TEXT_NOTHING_FOUND,
  ANSWERS_INFO_TEXT_NO_ANSWERS: ANSWERS_INFO_TEXT_NO_ANSWERS
}
